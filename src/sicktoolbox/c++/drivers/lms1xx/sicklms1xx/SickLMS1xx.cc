...
namespace SickToolbox {
   ...
   */
  void SickLMS1xx::Initialize( const bool disp_banner  )  {
   ...
   */
  sick_lms_1xx_scan_freq_t SickLMS1xx::GetSickScanFreq( ) const  {
   ...
   */
  sick_lms_1xx_scan_res_t SickLMS1xx::GetSickScanRes( ) const  {
   ...
   */
  double SickLMS1xx::GetSickStartAngle( ) const  {
   ...
   * \returns Sick LMS 1xx start angle as double
   */
  double SickLMS1xx::GetSickStopAngle( ) const  {
   ...
   */
  void SickLMS1xx::SetSickScanDataFormat( const sick_lms_1xx_scan_format_t scan_format )  {
   ...
   */
  void SickLMS1xx::Uninitialize( const bool disp_banner ) {
   ...
   */
  void SickLMS1xx::_setupConnection( )  {
   ...
   */
  void SickLMS1xx::_teardownConnection( )  {
   ...
   */
  void SickLMS1xx::_updateSickStatus( )  {
   ...
   */
  void SickLMS1xx::_getSickScanConfig( ) {
  ...
  void SickLMS1xx::_setSickScanConfig( const sick_lms_1xx_scan_freq_t scan_freq,
				       const sick_lms_1xx_scan_res_t scan_res,
				       const int start_angle, const int stop_angle )  {
    ...
    for (size_t i = 0; i < start_angle_str.length(); idx++, i++) {
    ...
    for (size_t i = 0; i < stop_angle_str.length(); idx++, i++) {
   ...
   */
  void SickLMS1xx::_setAuthorizedClientAccessMode()  {
   ...
   * \brief Login as an authorized client
   */
  void SickLMS1xx::_writeToEEPROM( )  {
   ...
   */
  void SickLMS1xx::_startMeasuring( )  {
   ...
   * \brief Tell the device to start measuring
   */
  void SickLMS1xx::_stopMeasuring( )  {
   ...
   */
  void SickLMS1xx::_requestDataStream( )  {
   ...
   */
  void SickLMS1xx::_startStreamingMeasurements( )  {
   ...
   */
  void SickLMS1xx::_stopStreamingMeasurements( const bool disp_banner )  {
   ...
   */
  void SickLMS1xx::_checkForMeasuringStatus( unsigned int timeout_value )  {
   ...
   * Set device to output only range values
   */
  void SickLMS1xx::_setSickScanDataFormat( const sick_lms_1xx_scan_format_t scan_format )  {
   ...
   * Set device to output only range values
   */
  void SickLMS1xx::_restoreMeasuringMode( )  {
   ...
   */
  void SickLMS1xx::_sendMessage( const SickLMS1xxMessage &send_message ) const  {
   ...
   */
  void SickLMS1xx::_recvMessage( SickLMS1xxMessage &sick_message ) const  {
