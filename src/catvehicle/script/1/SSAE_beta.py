...
class Side_Slip_Angle_Estimation(object):
    def __init__(self):
        ...
        self.pub2 = rospy.Publisher("/SSAE/x_dist", Float64, queue_size=10)
        self.pub3 = rospy.Publisher("/SSAE/y_dist", Float64, queue_size=10)
        self.pub4 = rospy.Publisher("/SSAE/psi", Float64, queue_size = 10)
    ...
    def EstCallback(self, processed_data):
        ...
        if np.abs(yaw_rate) < 0.01:
            ...
            #for beta smoothing
            # alpha = 0.2
            # Beta_t = alpha* Beta + (1-alpha)* self.last_beta_smooth
        ...
        self.pub2.publish(self.x0)
        self.pub3.publish(self.y0)
        self.pub4.publish(self.psi)
