...
function result = trajectory_generate()
    ...
    global S;                           % Streckenlaenge der Trajektorie gemessen 从轨迹起点开始测量的轨迹长度。
                                        %   ab dem Startpunkt der Trajektorie
                                        
    global Kappa;                       % Kruemmung der Trajektorie, Kappa = Kappa(s) 轨迹的曲率
    
    global X_mitte;                     % X-Koordinate der Trajektorie, X = X(s) 车辆轨迹
    global Y_mitte;                     % Y-Koordinate der Trajektorie, Y = Y(s)
    
    global X_links;                     % Linker Fahrbahnrand, X(s)车行道左侧边缘
    global Y_links;                     % Linker Fahrbahnrand, Y(s)
    
    global X_mitte_links;               % Mitte linker Fahrstreifen, X(s) 左中线
    global Y_mitte_links;               % Mitte linker Fahrstreifen, Y(s) 
    
    global X_rechts;                    % Rechter Fahrbahnrand, X(s)车行道右侧边缘
    global Y_rechts;                    % Rechter Fahrbahnrand, Y(s)
    
    global X_mitte_rechts;              % Mitte rechter Fahrstreifen, X(s) 右中线
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %
    % Der 2. Teil der Trajektrie ist eine Klothoide 螺旋线
    %
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    phi2a = phi1e;
    x2_start = x1_ende;
